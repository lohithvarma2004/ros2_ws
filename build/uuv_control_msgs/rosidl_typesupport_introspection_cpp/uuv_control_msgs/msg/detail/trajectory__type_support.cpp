...
{
  const auto & item = *reinterpret_cast<const uuv_control_msgs::msg::TrajectoryPoint *>(
    get_const_function__Trajectory__points(untyped_member, index));
  auto & value = *reinterpret_cast<uuv_control_msgs::msg::TrajectoryPoint *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<uuv_control_msgs::msg::TrajectoryPoint *>(
    get_function__Trajectory__points(untyped_member, index));
  const auto & value = *reinterpret_cast<const uuv_control_msgs::msg::TrajectoryPoint *>(untyped_value);
  item = value;
}
