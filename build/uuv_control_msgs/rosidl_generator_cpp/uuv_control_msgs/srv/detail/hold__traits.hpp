...
inline std::string to_yaml(const Hold_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const uuv_control_msgs::srv::Hold_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const uuv_control_msgs::srv::Hold_Request & msg)
{
...
inline std::string to_yaml(const Hold_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use uuv_control_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const uuv_control_msgs::srv::Hold_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  uuv_control_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use uuv_control_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const uuv_control_msgs::srv::Hold_Response & msg)
{
  return uuv_control_msgs::srv::to_yaml(msg);
}
