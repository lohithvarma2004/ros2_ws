...
inline void to_yaml(
  const uuv_control_msgs::srv::SetPIDParams_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const uuv_control_msgs::srv::SetPIDParams_Request & msg)
{
...
[[deprecated("use uuv_control_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const uuv_control_msgs::srv::SetPIDParams_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  uuv_control_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use uuv_control_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const uuv_control_msgs::srv::SetPIDParams_Response & msg)
{
  return uuv_control_msgs::srv::to_yaml(msg);
}
