...
bool uuv_control_msgs__srv__init_helical_trajectory__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uuv_control_msgs.srv._init_helical_trajectory.InitHelicalTrajectory_Request", full_classname_dest, 75) == 0);
  }
  uuv_control_msgs__srv__InitHelicalTrajectory_Request * ros_message = _ros_message;
  {  // start_time
  ...
  {  // n_turns
    PyObject * field = PyObject_GetAttrString(_pymsg, "n_turns");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->n_turns = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // delta_z
...
{
  /* NOTE(esteve): Call constructor of InitHelicalTrajectory_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("uuv_control_msgs.srv._init_helical_trajectory");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "InitHelicalTrajectory_Request");
  ...
  {  // n_turns
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->n_turns);
    {
      int rc = PyObject_SetAttrString(_pymessage, "n_turns", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool uuv_control_msgs__srv__init_helical_trajectory__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uuv_control_msgs.srv._init_helical_trajectory.InitHelicalTrajectory_Response", full_classname_dest, 76) == 0);
  }
  uuv_control_msgs__srv__InitHelicalTrajectory_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of InitHelicalTrajectory_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("uuv_control_msgs.srv._init_helical_trajectory");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "InitHelicalTrajectory_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
