...
bool uuv_control_msgs__msg__waypoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uuv_control_msgs.msg._waypoint.Waypoint", full_classname_dest, 39) == 0);
  }
  uuv_control_msgs__msg__Waypoint * ros_message = _ros_message;
  {  // header
  ...
  {  // use_fixed_heading
    PyObject * field = PyObject_GetAttrString(_pymsg, "use_fixed_heading");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->use_fixed_heading = (Py_True == field);
    Py_DECREF(field);
  }
  {  // radius_of_acceptance
    PyObject * field = PyObject_GetAttrString(_pymsg, "radius_of_acceptance");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->radius_of_acceptance = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * uuv_control_msgs__msg__waypoint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("uuv_control_msgs.msg._waypoint");
  ...
  {  // use_fixed_heading
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->use_fixed_heading ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "use_fixed_heading", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // radius_of_acceptance
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->radius_of_acceptance);
    {
      int rc = PyObject_SetAttrString(_pymessage, "radius_of_acceptance", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
