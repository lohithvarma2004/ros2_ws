  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uuv_control_msgs__srv__StartTrajectory_Request;
    is_plain =
      (
...
static size_t _StartTrajectory_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_uuv_control_msgs__srv__StartTrajectory_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = uuv_control_msgs__srv__StartTrajectory_Response;
    is_plain =
      (
...
static size_t _StartTrajectory_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_uuv_control_msgs__srv__StartTrajectory_Response(
    full_bounded, is_plain, 0);
