  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uuv_control_msgs__msg__WaypointSet;
    is_plain =
      (
...
static size_t _WaypointSet__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_uuv_control_msgs__msg__WaypointSet(
