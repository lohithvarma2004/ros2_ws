  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uuv_control_msgs::srv::AddWaypoint_Request;
    is_plain =
      (
...
// forward declaration of message dependencies and their conversion functions
// functions for uuv_control_msgs::msg::Waypoint already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = uuv_control_msgs::srv::AddWaypoint_Response;
    is_plain =
      (
