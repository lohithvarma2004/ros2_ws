  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uuv_world_ros_plugins_msgs__srv__GetCurrentModel_Request;
    is_plain =
      (
...
static size_t _GetCurrentModel_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_uuv_world_ros_plugins_msgs__srv__GetCurrentModel_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = uuv_world_ros_plugins_msgs__srv__GetCurrentModel_Response;
    is_plain =
      (
...
static size_t _GetCurrentModel_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_uuv_world_ros_plugins_msgs__srv__GetCurrentModel_Response(
    full_bounded, is_plain, 0);
