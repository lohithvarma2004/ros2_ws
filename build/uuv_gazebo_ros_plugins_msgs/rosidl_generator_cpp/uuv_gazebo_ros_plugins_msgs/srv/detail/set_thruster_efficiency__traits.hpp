...
inline void to_flow_style_yaml(
  const SetThrusterEfficiency_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: efficiency
...
inline std::string to_yaml(const SetThrusterEfficiency_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const uuv_gazebo_ros_plugins_msgs::srv::SetThrusterEfficiency_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const uuv_gazebo_ros_plugins_msgs::srv::SetThrusterEfficiency_Request & msg)
{
...
inline void to_flow_style_yaml(
  const SetThrusterEfficiency_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: success
...
inline std::string to_yaml(const SetThrusterEfficiency_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use uuv_gazebo_ros_plugins_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const uuv_gazebo_ros_plugins_msgs::srv::SetThrusterEfficiency_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  uuv_gazebo_ros_plugins_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use uuv_gazebo_ros_plugins_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const uuv_gazebo_ros_plugins_msgs::srv::SetThrusterEfficiency_Response & msg)
{
  return uuv_gazebo_ros_plugins_msgs::srv::to_yaml(msg);
}
