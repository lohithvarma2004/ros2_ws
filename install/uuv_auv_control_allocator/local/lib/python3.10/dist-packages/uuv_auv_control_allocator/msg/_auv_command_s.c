...
bool uuv_auv_control_allocator__msg__auv_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uuv_auv_control_allocator.msg._auv_command.AUVCommand", full_classname_dest, 53) == 0);
  }
  uuv_auv_control_allocator__msg__AUVCommand * ros_message = _ros_message;
  {  // header
  ...
  {  // surge_speed
    ...
    ros_message->surge_speed = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // command
    ...
    if (!geometry_msgs__msg__wrench__convert_from_py(field, &ros_message->command)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of AUVCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("uuv_auv_control_allocator.msg._auv_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AUVCommand");
  ...
  {  // command
    PyObject * field = NULL;
    field = geometry_msgs__msg__wrench__convert_to_py(&ros_message->command);
    if (!field) {
      return NULL;
    }
    {
