...
#ifndef GOOGLE_PROTOBUF_INCLUDED_Double_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_Double_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Double_2eproto;
...
class Double PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:uuv_gazebo_plugins_msgs.msgs.Double) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "uuv_gazebo_plugins_msgs.msgs.Double";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_Double_2eproto);
    return ::descriptor_table_Double_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
// required double value = 1 [default = 0];
inline bool Double::_internal_has_value() const {
...
inline double Double::_internal_value() const {
  return value_;
}
...
inline void Double::_internal_set_value(double value) {
  _has_bits_[0] |= 0x00000001u;
  value_ = value;
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_Double_2eproto
