  ...
  uuv_thruster_manager__srv__ThrusterManagerInfo_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    uuv_thruster_manager__srv__ThrusterManagerInfo_Request * data =
      (uuv_thruster_manager__srv__ThrusterManagerInfo_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!uuv_thruster_manager__srv__ThrusterManagerInfo_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          uuv_thruster_manager__srv__ThrusterManagerInfo_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  uuv_thruster_manager__srv__ThrusterManagerInfo_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    uuv_thruster_manager__srv__ThrusterManagerInfo_Response * data =
      (uuv_thruster_manager__srv__ThrusterManagerInfo_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!uuv_thruster_manager__srv__ThrusterManagerInfo_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          uuv_thruster_manager__srv__ThrusterManagerInfo_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
