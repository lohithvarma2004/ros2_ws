...
#ifndef UUV_THRUSTER_MANAGER__SRV__DETAIL__GET_THRUSTER_CURVE__FUNCTIONS_H_
#define UUV_THRUSTER_MANAGER__SRV__DETAIL__GET_THRUSTER_CURVE__FUNCTIONS_H_
...
/// Initialize srv/GetThrusterCurve message.
/**
...
/// Finalize srv/GetThrusterCurve message.
/**
...
/// Create srv/GetThrusterCurve message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * uuv_thruster_manager__srv__GetThrusterCurve_Request__init().
...
/// Destroy srv/GetThrusterCurve message.
/**
 * It calls
 * uuv_thruster_manager__srv__GetThrusterCurve_Request__fini()
...
/// Check for srv/GetThrusterCurve message equality.
/**
...
/// Copy a srv/GetThrusterCurve message.
/**
...
/// Initialize array of srv/GetThrusterCurve messages.
/**
...
/// Finalize array of srv/GetThrusterCurve messages.
/**
 * It calls
 * uuv_thruster_manager__srv__GetThrusterCurve_Request__fini()
...
/// Create array of srv/GetThrusterCurve messages.
/**
 * It allocates the memory for the array and calls
 * uuv_thruster_manager__srv__GetThrusterCurve_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetThrusterCurve messages.
/**
 * It calls
 * uuv_thruster_manager__srv__GetThrusterCurve_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetThrusterCurve message array equality.
/**
...
/// Copy an array of srv/GetThrusterCurve messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * uuv_thruster_manager__srv__GetThrusterCurve_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_uuv_thruster_manager
...
/**
 * It calls
 * uuv_thruster_manager__srv__GetThrusterCurve_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_uuv_thruster_manager
...
/**
 * It allocates the memory for the array and calls
 * uuv_thruster_manager__srv__GetThrusterCurve_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_uuv_thruster_manager
...
/**
 * It calls
 * uuv_thruster_manager__srv__GetThrusterCurve_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UUV_THRUSTER_MANAGER__SRV__DETAIL__GET_THRUSTER_CURVE__FUNCTIONS_H_
