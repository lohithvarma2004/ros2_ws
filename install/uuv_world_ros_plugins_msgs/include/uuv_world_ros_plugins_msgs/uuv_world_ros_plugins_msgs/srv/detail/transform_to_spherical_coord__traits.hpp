...
inline void to_yaml(
  const uuv_world_ros_plugins_msgs::srv::TransformToSphericalCoord_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const uuv_world_ros_plugins_msgs::srv::TransformToSphericalCoord_Request & msg)
{
...
[[deprecated("use uuv_world_ros_plugins_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const uuv_world_ros_plugins_msgs::srv::TransformToSphericalCoord_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  uuv_world_ros_plugins_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use uuv_world_ros_plugins_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const uuv_world_ros_plugins_msgs::srv::TransformToSphericalCoord_Response & msg)
{
  return uuv_world_ros_plugins_msgs::srv::to_yaml(msg);
}
