...
bool uuv_world_ros_plugins_msgs__srv__transform_to_spherical_coord__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uuv_world_ros_plugins_msgs.srv._transform_to_spherical_coord.TransformToSphericalCoord_Request", full_classname_dest, 94) == 0);
  }
  uuv_world_ros_plugins_msgs__srv__TransformToSphericalCoord_Request * ros_message = _ros_message;
  {  // input
...
PyObject * uuv_world_ros_plugins_msgs__srv__transform_to_spherical_coord__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("uuv_world_ros_plugins_msgs.srv._transform_to_spherical_coord");
...
ROSIDL_GENERATOR_C_EXPORT
bool uuv_world_ros_plugins_msgs__srv__transform_to_spherical_coord__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uuv_world_ros_plugins_msgs.srv._transform_to_spherical_coord.TransformToSphericalCoord_Response", full_classname_dest, 95) == 0);
  }
  uuv_world_ros_plugins_msgs__srv__TransformToSphericalCoord_Response * ros_message = _ros_message;
  {  // latitude_deg
