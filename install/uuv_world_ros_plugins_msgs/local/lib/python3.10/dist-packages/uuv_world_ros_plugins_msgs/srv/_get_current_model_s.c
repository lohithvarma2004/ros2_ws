...
bool uuv_world_ros_plugins_msgs__srv__get_current_model__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uuv_world_ros_plugins_msgs.srv._get_current_model.GetCurrentModel_Request", full_classname_dest, 73) == 0);
  }
  uuv_world_ros_plugins_msgs__srv__GetCurrentModel_Request * ros_message = _ros_message;
...
PyObject * uuv_world_ros_plugins_msgs__srv__get_current_model__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("uuv_world_ros_plugins_msgs.srv._get_current_model");
...
ROSIDL_GENERATOR_C_EXPORT
bool uuv_world_ros_plugins_msgs__srv__get_current_model__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uuv_world_ros_plugins_msgs.srv._get_current_model.GetCurrentModel_Response", full_classname_dest, 74) == 0);
  }
  uuv_world_ros_plugins_msgs__srv__GetCurrentModel_Response * ros_message = _ros_message;
  {  // mean
