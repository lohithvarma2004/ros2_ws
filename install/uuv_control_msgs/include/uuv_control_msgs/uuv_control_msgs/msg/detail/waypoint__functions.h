...
#ifndef UUV_CONTROL_MSGS__MSG__DETAIL__WAYPOINT__FUNCTIONS_H_
#define UUV_CONTROL_MSGS__MSG__DETAIL__WAYPOINT__FUNCTIONS_H_
 ...
 * calls
 * uuv_control_msgs__msg__Waypoint__init().
...
/**
 * It calls
 * uuv_control_msgs__msg__Waypoint__fini()
 ...
 * uuv_control_msgs__msg__Waypoint__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * uuv_control_msgs__msg__Waypoint__Sequence__fini()
 * on the array,
...
#endif  // UUV_CONTROL_MSGS__MSG__DETAIL__WAYPOINT__FUNCTIONS_H_
