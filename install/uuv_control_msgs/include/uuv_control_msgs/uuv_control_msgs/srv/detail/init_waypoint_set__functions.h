...
#ifndef UUV_CONTROL_MSGS__SRV__DETAIL__INIT_WAYPOINT_SET__FUNCTIONS_H_
#define UUV_CONTROL_MSGS__SRV__DETAIL__INIT_WAYPOINT_SET__FUNCTIONS_H_
...
/// Initialize srv/InitWaypointSet message.
/**
...
/// Finalize srv/InitWaypointSet message.
/**
...
/// Create srv/InitWaypointSet message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * uuv_control_msgs__srv__InitWaypointSet_Request__init().
...
/// Destroy srv/InitWaypointSet message.
/**
 * It calls
 * uuv_control_msgs__srv__InitWaypointSet_Request__fini()
...
/// Check for srv/InitWaypointSet message equality.
/**
...
/// Copy a srv/InitWaypointSet message.
/**
...
/// Initialize array of srv/InitWaypointSet messages.
/**
...
/// Finalize array of srv/InitWaypointSet messages.
/**
 * It calls
 * uuv_control_msgs__srv__InitWaypointSet_Request__fini()
...
/// Create array of srv/InitWaypointSet messages.
/**
 * It allocates the memory for the array and calls
 * uuv_control_msgs__srv__InitWaypointSet_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/InitWaypointSet messages.
/**
 * It calls
 * uuv_control_msgs__srv__InitWaypointSet_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/InitWaypointSet message array equality.
/**
...
/// Copy an array of srv/InitWaypointSet messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * uuv_control_msgs__srv__InitWaypointSet_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_uuv_control_msgs
...
/**
 * It calls
 * uuv_control_msgs__srv__InitWaypointSet_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_uuv_control_msgs
...
/**
 * It allocates the memory for the array and calls
 * uuv_control_msgs__srv__InitWaypointSet_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_uuv_control_msgs
...
/**
 * It calls
 * uuv_control_msgs__srv__InitWaypointSet_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UUV_CONTROL_MSGS__SRV__DETAIL__INIT_WAYPOINT_SET__FUNCTIONS_H_
